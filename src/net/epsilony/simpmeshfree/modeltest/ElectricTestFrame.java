 ...
 */
package net.epsilony.simpmeshfree.modeltest;
...
import net.epsilony.simpmeshfree.model2D.BoundaryConditions;
import net.epsilony.simpmeshfree.model2D.Model;
import net.epsilony.simpmeshfree.model2D.LineSegment;
...
import net.epsilony.simpmeshfree.processor2D.ElectricModel;
import net.epsilony.simpmeshfree.processor2D.MechanicsModel;
import net.epsilony.simpmeshfree.processor2D.SupportDomain;
...
public class ElectricTestFrame extends javax.swing.JFrame {
...

    {
        ...
        gm.generateApproximatePoints(0.1, 0.1);
