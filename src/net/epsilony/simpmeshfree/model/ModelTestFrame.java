...
public class ModelTestFrame extends javax.swing.JFrame {
    ...
    MechanicsModel mm=new MechanicsModel(gm);
    {
        ...
        mm.generateNodesByTriangle(1.4,0.1, "pa0.8nQ", true, true);
        mm.generateQuadratureDomainsByTriangle(2, 0.1, "pq35a2nQ");
//        mm.generateQuadratureDomainsByTriangle();
        ...
        RadialBasisFunction rbf=new MultiQuadRadial(4, 1.03);
